...
function buildSamlResponse(options) {
    ...
    if (options.signResponse) {
        ...
        sig.addReference(
            "//*[local-name(.)='Response' and namespace-uri(.)='urn:oasis:names:tc:SAML:2.0:protocol']", ["http://www.w3.org/2000/09/xmldsig#enveloped-signature", "http://www.w3.org/2001/10/xml-exc-c14n#"],
...
function getLogoutResponse(options, callback) {
    ...
    if (options.signResponse) {
        ...
        sig.addReference("//*[local-name(.)='LogoutResponse' and namespace-uri(.)='urn:oasis:names:tc:SAML:2.0:protocol']", ['http://www.w3.org/2000/09/xmldsig#enveloped-signature', 'http://www.w3.org/2001/10/xml-exc-c14n#'],
            algorithms.digest[options.digestAlgorithm]);
...
module.exports.auth = function(options) {
    ...
    opts.getUserFromRequest = opts.getUserFromRequest || function(req) {
        return req.user;
    };
    ...
    return function(req, res, next) {
        module.exports.parseLogoutRequest(req, function(err, logoutRequestData) {
            ...
            if (!logoutRequestData) {
                return res.send(400, 'missing SAMLRequest');
            }
